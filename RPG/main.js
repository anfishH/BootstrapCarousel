    ...
    imgMountain.onload = function(){
        imgEnemy.onload = function(){
            for(let x in mapArray){
                if(mapArray[x]==1){
                    ctx.drawImage(imgMountain, 94, 160, 32, 32, x%3*200, Math.floor(x/3)*200, 200, 200);
                }else if(mapArray[x]==3){
                    ctx.drawImage(imgEnemy, 350, 40, 70, 135, x%3*200, Math.floor(x/3)*200, 200, 200);
                }
                else if(mapArray[x]==2){
                    ctx.drawImage(imgMountain, 0, 65, 32, 32, x%3*200, Math.floor(x/3)*200, 200, 200);
                }
            }
        }
    };
